      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="glass-panel rounded-xl p-6">
            ...
            <p className="text-[var(--atum-text-1)]">Manage user accounts</p>
          </div>
          <div className="glass-panel rounded-xl p-6">
            <h3 className="text-xl font-semibold mb-3">Organizations</h3>
            <p className="text-[var(--atum-text-1)]">Manage organizations</p>
          </div>
          <div className="glass-panel rounded-xl p-6">
            <h3 className="text-xl font-semibold mb-3">Settings</h3>
            <p className="text-[var(--atum-text-1)]">System configuration</p>
          </div>
        </div>
      </div>
    </div>
